...
const en = {
  ...
  faq: {
    ...
    appointmentInstruction: "You can book an appointment online by clicking the [BOOK_APPOINTMENT_LINK] on the hospital's website.",
  },
  registrationPage: {
  ...
  adminLoginPage: {
    ...
    loginPrompt: "Please log in with your new credentials.",
...
const hi: typeof en = {
 ...
 popularServices: {
  ...
  faq: {
    ...
    appointmentInstruction: "आप अस्पताल की वेबसाइट पर [BOOK_APPOINTMENT_LINK] पर क्लिक करके ऑनलाइन अपॉइंटमेंट बुक कर सकते हैं।",
  },
  registrationPage: {
  ...
  registrationForm: {
    ...
    visitInfo: 'विज़िट जानकारी',
    reason: {
      label: 'दौरे का कारण',
      placeholder: 'एक कारण चुनें',
      options: {
  ...
  adminLoginPage: {
    ...
    redirectingMessage: "डैशबोर्ड पर पुनर्निर्देशित किया जा रहा है...",
    loginPrompt: "कृपया अपनी नई क्रेडेंशियल के साथ लॉग इन करें।",
...
const mr: typeof en = {
  ...
  faq: {
    ...
    appointmentInstruction: "तुम्ही रुग्णालयाच्या वेबसाइटवर [BOOK_APPOINTMENT_LINK] वर क्लिक करून ऑनलाइन अपॉइंटमेंट बुक करू शकता.",
  },
  registrationPage: {
  ...
  adminLoginPage: {
    ...
    redirectingMessage: "डॅशबोर्डवर पुनर्निर्देशित करत आहे...",
    loginPrompt: "कृपया आपल्या नवीन क्रेडेन्शियलसह लॉगिन करा.",
